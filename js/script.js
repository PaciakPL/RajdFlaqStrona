...
$(document).ready(function () {
    ...
    function countdown() {
        ...
        var launch_date = new Date(Date.UTC(2019, 8, 13, 17, 0));
        var days;
        var hours;
        var minutes;
        var seconds;
        ...
        ctd.innerHTML =
            '<li><div><span class="h5">' + days + '</span><br> dni' + '</div></li>' +
            '<li><div><span class="h5">' + hours + '</span><br> godzin' + '</div></li>' +
            '<li><div><span class="h5">' + minutes + '</span><br> minut' + '</div></li>' +
            '<li><div><span class="h5">' + seconds + '</span><br> sekund'  + '</div></li>';
    }
